...
!function(e, t) {
    ...
    var Z = {
      ...
      , ae = {
        ...
        in: function(e) {
            var t, a, i, s, r, n, o, d, p, u, c, h, v, f, m, g, b = this, w = l(), y = b.zoom, E = b.params.zoom, x = y.gesture, T = y.image;
...
!function(e) {
    ...
    e.fn.materialScrollTop = function() {
        var e = this
          , t = arguments[0];
        e.length;
        return "object" != typeof t && void 0 !== t || (e[0].materialScrollTop = new n(e[0],t)),
        e
    }
}(jQuery);
...
$(function() {
    ...
    $(e).submit(function(r) {
        ...
        $.ajax({
            ...
            $(t).addClass("error"),
            "" !== e.responseText ? $(t).text(e.responseText) : $(t).text("Oops! An error occured and your message could not be sent.")
        })
    })
});
